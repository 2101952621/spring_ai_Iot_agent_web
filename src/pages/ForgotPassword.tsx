        ...
        {!sent ? (
          <>
            <div className="mb-8 text-center">
              ...
              <h1 className="text-2xl font-bold text-slate-800">忘记密码</h1>
              <p className="mt-1 text-sm text-slate-500">输入注册邮箱，我们将发送密码重置链接</p>
            </div>
          ...
          <>
            <div className="mb-8 text-center">
              ...
              <h1 className="text-2xl font-bold text-slate-800">邮件已发送</h1>
              <p className="mt-2 text-sm text-slate-500">
                我们已将密码重置链接发送至
                <span className="font-medium text-slate-700 ml-1">{email}</span>
                ，请前往邮箱查收并按提示重置密码。
              </p>
            </div>
          </>
